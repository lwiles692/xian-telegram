...
DUNGEONS = {
    ...
    "xukong": {
        "name": "虚空神殿", "realm": 5, "layers": 6, "stamina": 70, "entry_stone": 4000,
        "daily_limit": 2,
        "stone": (2800, 4700), "cult": 16000,
        "mobs": [
            _mob("虚空殿卫", 405000, 38200, 18000, 1750, 820, ("普攻", "快剑斩")),
            _mob("太虚星奴", 437400, 40110, 17100, 1820, 860, ("普攻", "烈火诀", "金钟罩")),
        ],
        "boss": _mob(
            "虚空神君", 1500000, 56000, 30000, 2100, 1200,
            ("普攻", "快剑斩", "烈火诀", "金钟罩")),
        "drops": [
            ("炼虚丹残方", 10, 1, 1),
            ("炼虚装备图纸残页", 12, 1, 2),
